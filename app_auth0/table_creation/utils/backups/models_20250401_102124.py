...
class AdminRolePermissions:
    ...
    def __init__(self, id=None, role_id=None, permission_id=None, created_at=None):
...
class UserAdminRoles:
    ...
    def __init__(self, id=None, user_id=None, role_id=None, assigned_by=None, created_at=None, updated_at=None):
        self.user_id = user_id
        self.role_id = role_id
...
class Users:
    ...
    def __init__(self, id=None, email=None, username=None, auth0_id=None, created_at=None, last_login=None, is_active=None, email_verified=None, preferred_study_time=None, notification_preferences=None, study_goals=None, stripe_customer_id=None, picture=None):
        self.id = id or str(uuid.uuid4())
        self.email = email
...
class ContentSubjectRelationships:
    ...
    def __init__(self, id=None, content_type=None, content_id=None, subject_id=None, subject_type=None, relationship_type=None, created_at=None, updated_at=None):
        self.id = id or str(uuid.uuid4())
        self.content_type = content_type
        self.content_id = content_id
