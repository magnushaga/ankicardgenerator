...
CREATE TABLE IF NOT EXISTS content_subject_relationships (
    id UUID NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_content_subject_relationships_content_type_content_id ON content_subject_relationships(content_type, content_id);

CREATE INDEX IF NOT EXISTS idx_content_subject_relationships_subject_id_subject_type ON content_subject_relationships(subject_id, subject_type);
...
CREATE TABLE IF NOT EXISTS live_deck_cards (
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (card_id) REFERENCES cards(id) ON DELETE CASCADE,
    FOREIGN KEY (live_deck_topic_id) REFERENCES live_deck_topics(id) ON DELETE CASCADE,
    FOREIGN KEY (modified_by) REFERENCES users(id) ON DELETE CASCADE
);
...
CREATE INDEX IF NOT EXISTS idx_live_deck_cards_live_deck_topic_id_card_id ON live_deck_cards(live_deck_topic_id, card_id);
...
CREATE TABLE IF NOT EXISTS subject_categories (
    ...
    updated_at TIMESTAMP NULL,
    PRIMARY KEY (id),
    FOREIGN KEY (parent_id) REFERENCES subject_categories(id) ON DELETE CASCADE
);

CREATE INDEX IF NOT EXISTS idx_subject_categories_parent_id ON subject_categories(parent_id);
...
CREATE TABLE IF NOT EXISTS decks (
    ...
    last_modified TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
    modified_by VARCHAR(36) NULL,
    main_subject_id UUID NULL,
    subcategory_ids ARRAY NULL DEFAULT '{}'::uuid[],
    source_textbook_id UUID NULL,
    PRIMARY KEY (id),
    FOREIGN KEY (main_subject_id) REFERENCES subject_categories(id) ON DELETE CASCADE,
    FOREIGN KEY (modified_by) REFERENCES users(id) ON DELETE CASCADE,
    FOREIGN KEY (source_textbook_id) REFERENCES textbooks(id) ON DELETE CASCADE
);
...
CREATE INDEX IF NOT EXISTS idx_live_deck_parts_live_deck_id_part_id ON live_deck_parts(live_deck_id, part_id);
...
CREATE TABLE IF NOT EXISTS live_deck_topics (
    id UUID NOT NULL DEFAULT uuid_generate_v4(),
    live_deck_chapter_id UUID NULL,
    topic_id UUID NULL,
    is_active BOOLEAN NULL DEFAULT true,
    last_modified TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
    modified_by VARCHAR(36) NULL,
    created_at TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
    FOREIGN KEY (live_deck_chapter_id) REFERENCES live_deck_chapters(id) ON DELETE CASCADE,
    FOREIGN KEY (modified_by) REFERENCES users(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_live_deck_topics_live_deck_chapter_id_topic_id ON live_deck_topics(live_deck_chapter_id, topic_id);
...
CREATE TABLE IF NOT EXISTS live_deck_chapters (
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (chapter_id) REFERENCES chapters(id) ON DELETE CASCADE,
    FOREIGN KEY (live_deck_part_id) REFERENCES live_deck_parts(id) ON DELETE CASCADE,
    FOREIGN KEY (modified_by) REFERENCES users(id) ON DELETE CASCADE
);
...
CREATE INDEX IF NOT EXISTS idx_live_deck_chapters_live_deck_part_id_chapter_id ON live_deck_chapters(live_deck_part_id, chapter_id);
...
CREATE TABLE IF NOT EXISTS subject_subcategories (
    id UUID NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_subject_subcategories_category_id ON subject_subcategories(category_id);